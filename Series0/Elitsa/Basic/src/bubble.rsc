...
public bool sorted3(list[int] lst) = isSorted(sort3(lst));
...
public list[int] eho([*int nums1, int p, *int nums2, int q,*int nums3]) {
	println("<p>");
  // println("<nums2>");
   println("<q>");
...
public bool sorted4(list[int] lst) = isSorted(sort4(lst));
